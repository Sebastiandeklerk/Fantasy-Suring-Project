...
library(caret)
library(car)
Data<-read_excel("Event9.xlsx", sheet = "Surfer Stats - Event 9")
Data<-Data[,-c(1,2,5)]
Data$`Previous 8 Event Points`<-as.numeric(Data$`Previous 8 Event Points`)
Data$`Previous 8 heat average`<-as.numeric(Data$`Previous 8 heat average`)
