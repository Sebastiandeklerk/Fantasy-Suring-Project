...
library(caret)
library(car)
Data<-read_excel("Event9.xlsx", sheet = "Surfer Stats - Event 10")
Data<-Data[,-c(1,2,5)]
Data$`Previous 9 Event Points`<-as.numeric(Data$`Previous 9 Event Points`)
Data$`Previous 9 heat average`<-as.numeric(Data$`Previous 9 heat average`)
