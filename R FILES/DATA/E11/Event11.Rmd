...
library(caret)
library(car)
Data<-read_excel("Event11.xlsx", sheet = "Surfer Stats - Event 11")
Data<-Data[,-c(1,2,5)]
Data$`Previous 10 Event Points`<-as.numeric(Data$`Previous 10 Event Points`)
Data$`Previous 10 heat average`<-as.numeric(Data$`Previous 10 heat average`)
